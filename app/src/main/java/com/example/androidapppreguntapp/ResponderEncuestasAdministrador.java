...
public class ResponderEncuestasAdministrador extends AppCompatActivity implements View.OnClickListener {
    ImageView trumo;
    ...
    public void onClick(View view){
        ResponderEncuestasAdministrador r = new ResponderEncuestasAdministrador();
        switch (view.getId()){
    ...
    private void irASiguientePregunta(){
        Intent intent = new Intent(this, ResponderEncuestasAdministrador.class);
